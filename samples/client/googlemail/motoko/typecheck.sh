#!/bin/bash
# Typecheck generated Gmail Motoko client code
...
TMPBUILD=$(mktemp -d /tmp/googlemail-build-test-XXXXXX)
...
[package]
name = "googlemail-build-test"
version = "0.0.1"

[dependencies]
googlemail-client = "$GENERATED_ABS"
