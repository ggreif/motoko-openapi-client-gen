# HTTPBin Auth Test API

Test API for bearer token authentication using httpbin.org endpoints
...
- GetHeaders200Response
- TestBearer200Response
...
```motoko
import HTTPBin Auth Test API "path/to/generated/modules";
```
